  ...
  create: [
    {
      id: -1,
      nodes: [
        { id: -2, lon: 16, lat: 16, version: 0, type: 'node' },
        { id: -3, lon: 17, lat: 17, version: 0, type: 'node' },
        { id: -4, lon: 18, lat: 18, version: 0, type: 'node' },
        { id: -5, lon: 19, lat: 19, version: 0, type: 'node' },
      ],
      type: 'way',
      version: 0,
      tags: { dog: 'meow' },
...
const modifyLineString: OsmChange = {
  ...
  generator: 'osm_change_generator',
  version: '0.6',
  create: [{ id: -1, lon: 19, lat: 19, version: 0, type: 'node' }] as OsmElement[],
  modify: [
    {
      id: 1,
      nodes: [
        { id: 2, lon: 16, lat: 16, version: 1, type: 'node' },
        { id: 4, lon: 17, lat: 17, version: 1, type: 'node' },
        { id: 3, lon: 18, lat: 18, version: 2, type: 'node' },
        { id: -1, lon: 19, lat: 19, version: 0, type: 'node' },
      ],
      type: 'way',
      version: 3,
      tags: { dog: 'meow' },
