...
describe('ChangeManager', () => {
  ...
  describe('#generateChange', () => {
    ...
    it.each(allFeaturesOnModifyAndDelete)(
      'should throw ParseOsmElementsError if osmElements is empty on %s action and %s feature',
      (action: Actions, type: FeatureType) => {
    ...
    it.each([Actions.MODIFY, Actions.DELETE])(
      'should throw ParseOsmElementsError if osmElements is missing node element on %s action',
      (action: Actions) => {
